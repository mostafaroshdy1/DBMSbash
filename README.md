...
- **src:** Contains all resources needed (as scripts).
- **db:** Contains scripts for performing database-related operations.
- **table:** Contains scripts for performing table-related operations.
